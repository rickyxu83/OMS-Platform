...
#
# 流程:
#   1. 把本地 fixture-data.js 推送到远程服务器
...
SEED_SRC="backend/src/modules/device-model-catalog/fixture-data.js"
SEED_DST="$REMOTE_ROOT/app/backend/src/modules/device-model-catalog/fixture-data.js"
CONTAINER="service-sheet-aliyun-backend"

echo "=== 1/4 推送 fixture-data.js 到服务器 ==="
