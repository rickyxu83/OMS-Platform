...
router.post('/maintenance-import/preview', requirePermission('device.edit'), controller.uploadImportMiddleware, controller.previewMaintenanceImport)
router.post('/maintenance-import/apply', requirePermission('device.edit'), controller.uploadImportMiddleware, controller.applyMaintenanceImport)
