...
router.get('/recognition-rules', requirePermission('mr.view'), controller.listRecognitionRules)
router.put('/recognition-rules/:id', requirePermission('mr.edit'), controller.updateRecognitionRule)
router.delete('/recognition-rules/:id', requirePermission('mr.edit'), controller.deleteRecognitionRule)
...
router.put('/:id/purchase-draft', requirePermission('mr.purchase'), controller.savePurchaseDraft)
router.post('/:id/import', requirePermission('mr.edit'), controller.quotationUpload, controller.importQuotation)
router.post('/:id/quote-coach/chat', requirePermission('mr.edit'), controller.quoteCoachChat)
router.post('/:id/quote-coach/distill', requirePermission('mr.edit'), controller.quoteCoachDistill)
