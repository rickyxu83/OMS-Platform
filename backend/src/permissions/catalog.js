...
const PERMISSION_ENTRIES = Object.freeze([
  ...
  ['attendance.apply', '提交后勤考勤申请', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'administrative_supervisor', 'sales_supervisor', 'sales', 'engineer']],
