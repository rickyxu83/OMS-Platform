...
const PERMISSION_ENTRIES = Object.freeze([
  ['workspace.admin', '管理工作台', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'sales_supervisor', 'sales']],
  ['workspace.engineer', '工程师工作台', ['engineer', 'engineering_supervisor']],
  ['order.view', '查看工单', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'sales', 'sales_supervisor']],
  ...
  ['inspection.view', '查看巡检计划', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'sales', 'sales_supervisor']],
  ...
  ['customer.view', '查看客户', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'sales', 'sales_supervisor']],
  ...
  ['device.view', '查看设备', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'sales', 'sales_supervisor']],
  ['device.create', '创建设备', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'engineer']],
  ['device.edit', '编辑设备', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'engineer']],
  ...
  ['maintenance-party.view', '查看维保厂商', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'sales', 'sales_supervisor']],
  ['maintenance-party.create', '创建维保厂商', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'sales_supervisor', 'engineer']],
  ['maintenance-party.edit', '编辑维保厂商', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'sales_supervisor', 'engineer']],
  ['maintenance-party.delete', '删除维保厂商', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'sales_supervisor']],
  ['timesheet.view', '查看工时报表', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'sales', 'sales_supervisor']],
  ['user.view', '查看用户', ['admin', 'assistant', 'dispatcher', 'operations_director', 'engineering_supervisor', 'sales_supervisor']],
