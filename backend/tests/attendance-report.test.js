...
;(async () => {
  ...
  assert.equal(workbook.getWorksheet('请假统计').getCell('A1').fill.fgColor.argb, 'FF38185C')
  assert.equal(workbook.getWorksheet('请假统计').getCell('A11').fill.fgColor.argb, 'FF582B8B')
