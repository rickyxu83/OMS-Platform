          ...
          <Card>
            ...
            <CardContent className="space-y-5">
              <div className="grid gap-3 md:grid-cols-2">
                ...
                <div className="flex items-center justify-between rounded-lg border p-3">
                  <div>
                    <div className="font-medium">假勤审批邮件</div>
...
- 请补充客户资料`}
          ...
          <section className="space-y-4">
            ...
            <div className="rounded-lg border bg-muted/20 p-3 text-sm text-muted-foreground">
              系统每天 07:00 检查巡检执行，08:00 检查维保到期，08:10 检查逾期巡检；每周一 08:30 检查维保信息待完善设备，08:35 检查客户缺少销售，08:40 检查巡检日期待完善；每月 1 号 08:20 发送月度总结；销售服务单通知每 5 分钟检查一次到期队列。假勤模块启用时，每年 11~12 月每天 09:15 自动同步来年法定节假日，成功或失败都会邮件通知管理员（失败每周一提醒，12 月 15 日起每天提醒）。
            </div>
          </section>
          ) : null}
        </div>
