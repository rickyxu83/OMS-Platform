/**
 * ServiceReport 页客户内联建议组件（自 6200 行单文件拆出）。
 */
import { useMemo, useRef, useState } from "react";
import { Building2 } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import type { CustomerContact, CustomerOption } from "./types";
import { CUSTOMER_INDEX_LETTERS } from "./constants";
import {
  contactKey, contactsForCustomer, customerInitial, customerMatches, customerMeta, customerName,
} from "./utils";

export function CustomerInlineSuggestions({
  open,
  searching,
  recentCustomers,
  groups,
