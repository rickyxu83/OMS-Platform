...
export const saveMrPurchaseDraft = (id: string | number, body: { items: Array<{ id: string | number; companyPartNo: string; purchaseOrderNo: string; shipmentNo: string }>; note?: string }) => api.put(`/mr/${pathId(id)}/purchase-draft`, body) as Promise<MrOrder>
