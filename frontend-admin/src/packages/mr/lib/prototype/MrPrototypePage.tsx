...
function VariantB({ order, patch }: PrototypeProps) {
  return (
    <div className="min-h-screen bg-white pb-28">
      ...
      <main className="mx-auto grid max-w-[1600px] gap-6 px-4 py-6 sm:px-6 min-[1400px]:grid-cols-[minmax(0,1fr)_320px]">
        <div className="min-w-0 space-y-7">
          ...
          <section className="grid gap-px border bg-border min-[1200px]:grid-cols-3">
