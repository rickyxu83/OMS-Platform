      ...
      <article className="mr-print-root mx-auto max-w-[1400px] bg-white p-5 shadow-sm">
        ...
        <table className="mr-meta text-[9px]">
          <tbody>
            ...
            <tr><th>签合约</th><td>{choice(order.hasContract)}</td><th>合约类型</th><td>{text(order.contractType)}</td><th>罚则</th><td>{choice(order.hasPenalty)}</td><th>罚则内容</th><td>{text(order.penaltyContent)}</td></tr>
