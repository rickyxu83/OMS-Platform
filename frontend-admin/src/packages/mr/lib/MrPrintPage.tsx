...
@media screen{.mr-document{border-top:3px solid #6d5bd0}.a-orderbar{background:#f7f4fd}.a-section-title{border-bottom-color:#e7e2f6}.a-items th{color:#4b3f8f;border-bottom-color:#6d5bd0!important}.a-totals{background:#f5f1fd}.a-fact-group{background:#faf8ff}.a-notes-card{background:#f5f1fc}.a-signature{border-left-color:#ece7f6}}
`
