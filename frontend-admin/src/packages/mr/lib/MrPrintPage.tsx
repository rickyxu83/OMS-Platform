...
.mr-document{position:relative;overflow:hidden}.a-watermarks{pointer-events:none;position:absolute;inset:0;z-index:2;overflow:hidden}.a-watermark{position:absolute;transform:rotate(-18deg);color:#b91c1c4a;font-size:44px;font-weight:800;text-align:center;letter-spacing:.08em;white-space:nowrap}.a-watermark:nth-child(1){left:6%;top:15%}.a-watermark:nth-child(2){left:40%;top:15%}.a-watermark:nth-child(3){left:74%;top:15%}.a-watermark:nth-child(4){left:6%;top:56%}.a-watermark:nth-child(5){left:40%;top:56%}.a-watermark:nth-child(6){left:74%;top:56%}.a-signature-reason{margin-top:3px;overflow-wrap:anywhere}.mr-print-page.is-embedded{min-height:0;padding:0;background:transparent}.mr-print-page.is-embedded .mr-document{max-width:none}
      ...
      <article className="mr-document">
        {watermark ? (
          <div className="a-watermarks">
            {Array.from({ length: 6 }).map((_, index) => <div className="a-watermark" key={index}>{watermark}</div>)}
          </div>
        ) : null}
