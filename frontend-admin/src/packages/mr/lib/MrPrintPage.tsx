...
// 页眉订货条已精简为 客户/交付/状态 三栏：以下字段归入下方订购与交付资料区（用户反馈头部灰字看不清、信息分散 2026-09-09）
